...
<div class="scroll-sidebar" data-simplebar>
  ...
  <nav class="sidebar-nav">
    <ul id="sidebarnav" class="mb-0">
      ...
      <li class="sidebar-item">
        <a class="sidebar-link sidebar-link success-hover-bg" href="index2.html" aria-expanded="false">
      ...
      <li class="sidebar-item">
        ...
        <ul aria-expanded="false" class="collapse first-level">
          ...
          <li class="sidebar-item">
            <a href="eco-shop2.html" class="sidebar-link">
              <span class="sidebar-icon"></span>
          ...
          <li class="sidebar-item">
            <a href="eco-shop-detail2.html" class="sidebar-link">
              <span class="sidebar-icon"></span>
      ...
      <li class="sidebar-item">
        <a class="sidebar-link indigo-hover-bg" href="app-email.html" aria-expanded="false">
      ...
      <li class="sidebar-item">
        <a class="sidebar-link info-hover-bg" href="app-calendar.html" aria-expanded="false">
      ...
      <li class="sidebar-item">
        <a class="sidebar-link success-hover-bg" href="apps-kanban.html" aria-expanded="false">
          <span class="aside-icon p-2 bg-success-subtle rounded-1">
      ...
      <li class="sidebar-item">
        <a class="sidebar-link primary-hover-bg" href="app-chat.html" aria-expanded="false">
          <span class="aside-icon p-2 bg-primary-subtle rounded-1">
      ...
      <li class="sidebar-item">
        <a class="sidebar-link warning-hover-bg" href="app-contact2.html" aria-expanded="false">
          <span class="aside-icon p-2 bg-warning-subtle rounded-1">
      ...
      <li class="sidebar-item">
        <a class="sidebar-link danger-hover-bg" href="app-invoice.html" aria-expanded="false">
          <span class="aside-icon p-2 bg-danger-subtle rounded-1">
      ...
      <li class="sidebar-item">
        <a class="sidebar-link primary-hover-bg" href="page-account-settings.html" aria-expanded="false">
          <span class="aside-icon p-2 bg-primary-subtle rounded-1">
            <iconify-icon icon="solar:user-circle-line-duotone" class="fs-6"></iconify-icon>
          </span>
      ...
      <!-- =================== -->
      <li class="sidebar-item">
        <a class="sidebar-link sidebar-link indigo-hover-bg my-3" href="classes.html" aria-expanded="false">
          <span class="aside-icon p-2 bg-indigo-subtle rounded-1">
      ...
      <!-- =================== -->
      <li class="sidebar-item">
        <a class="sidebar-link sidebar-link warning-hover-bg" href="form-wizard.html" aria-expanded="false">
          <span class="aside-icon p-2 bg-warning-subtle rounded-1">
      ...
      <!-- =================== -->
      <li class="sidebar-item">
        <a class="sidebar-link sidebar-link primary-hover-bg" href="form-repeater.html" aria-expanded="false">
          <span class="aside-icon p-2 bg-primary-subtle rounded-1">
      ...
      <!-- =================== -->
      <li class="sidebar-item">
        <a class="sidebar-link sidebar-link primary-hover-bg" href="table-jsgrid.html" aria-expanded="false">
          <span class="aside-icon p-2 bg-primary-subtle rounded-1">
            <iconify-icon icon="solar:align-top-line-duotone" class="fs-6"></iconify-icon>
          </span>
          <span class="hide-menu ps-1">Table Jsgrid</span>
        </a>
      </li>
      ...
      <!-- =================== -->
      <li class="sidebar-item">
        <a class="sidebar-link sidebar-link secondary-hover-bg" href="table-responsive.html" aria-expanded="false">
          <span class="aside-icon p-2 bg-secondary-subtle rounded-1">
            <iconify-icon icon="solar:align-horizonta-spacing-line-duotone" class="fs-6"></iconify-icon>
          </span>
          <span class="hide-menu ps-1">Table Responsive</span>
        </a>
      </li>
      ...
      <!-- =================== -->
      <li class="sidebar-item">
        <a class="sidebar-link sidebar-link success-hover-bg" href="table-footable.html" aria-expanded="false">
          <span class="aside-icon p-2 bg-success-subtle rounded-1">
            <iconify-icon icon="solar:stop-line-duotone" class="fs-6"></iconify-icon>
          </span>
          <span class="hide-menu ps-1">Table Footable</span>
        </a>
      </li>
      ...
      <!-- =================== -->
      <li class="sidebar-item">
        <a class="sidebar-link sidebar-link warning-hover-bg" href="table-editable.html" aria-expanded="false">
          <span class="aside-icon p-2 bg-warning-subtle rounded-1">
            <iconify-icon icon="solar:documents-minimalistic-line-duotone" class="fs-6"></iconify-icon>
          </span>
          <span class="hide-menu ps-1">Table Editable</span>
        </a>
      </li>
      ...
      <!-- =================== -->
      <li class="sidebar-item">
        <a class="sidebar-link sidebar-link danger-hover-bg" href="table-bootstrap.html" aria-expanded="false">
          <span class="aside-icon p-2 bg-danger-subtle rounded-1">
            <iconify-icon icon="solar:chart-square-line-duotone" class="fs-6"></iconify-icon>
          </span>
          <span class="hide-menu ps-1">Table Bootstrap</span>
        </a>
      </li>
      ...
      <!-- =================== -->
      <li class="sidebar-item">
        <a class="sidebar-link sidebar-link secondary-hover-bg" href="icon-tabler.html" aria-expanded="false">
          <span class="aside-icon p-2 bg-secondary-subtle rounded-1">
      ...
      <li class="sidebar-item">
        <a class="sidebar-link sidebar-link success-hover-bg" href="authentication-error.html" aria-expanded="false">
          <span class="aside-icon p-2 bg-success-subtle rounded-1">
            <iconify-icon icon="solar:danger-circle-line-duotone" class="fs-6"></iconify-icon>
          </span>
      ...
      <li class="sidebar-item">
        <a class="sidebar-link sidebar-link primary-hover-bg" href="authentication-maintenance.html"
          aria-expanded="false">
          <span class="aside-icon p-2 bg-primary-subtle rounded-1">
  ...
  <div class="card bg-primary-subtle mb-0 shadow-none">
    <div class="card-body p-4">
      <div class="d-flex align-items-center justify-content-between gap-3">
        ...
        <a href="authentication-login.html" class="position-relative" data-bs-toggle="tooltip" data-bs-placement="top"
...
<div class="message-body" data-simplebar>
  <a href="javascript:void(0)" class="dropdown-item px-7 d-flex align-items-center py-6">
    <span class="flex-shrink-0">
      <img src="../assets/images/profile/user-1.jpg" alt="user" width="45" class="rounded-circle" />
    </span>
    <div class="w-75 d-inline-block v-middle ps-3">
      <h5 class="mb-0 fs-4 fw-normal">
        Roman Joined the Team!
      </h5>
      <span class="fs-3 text-nowrap d-block fw-normal mt-1 text-muted">Congratulate him</span>
  ...
  <a href="javascript:void(0)" class="dropdown-item px-7 d-flex align-items-center py-6">
    ...
    <div class="w-75 d-inline-block v-middle ps-3">
      ...
      <span class="fs-3 text-nowrap d-block fw-normal mt-1 text-muted">Salma sent you new
        message</span>
      <span class="fs-2 text-nowrap d-block text-muted">9:08 AM</span>
    </div>
  </a>
  ...
  <a href="javascript:void(0)" class="dropdown-item px-7 d-flex align-items-center py-6">
    ...
    <div class="w-75 d-inline-block v-middle ps-3">
      ...
      <span class="fs-3 text-nowrap d-block fw-normal mt-1 text-muted">Check your
        earnings</span>
      <span class="fs-2 text-nowrap d-block text-muted">9:08 AM</span>
    </div>
  </a>
...
<div class="py-6 px-7 mb-1">
          ...
          <a class="nav-link position-relative ms-6" href="javascript:void(0)" id="drop1" data-bs-toggle="dropdown"
            ...
            <div class="d-flex align-items-center flex-shrink-0">
              <div class="user-profile me-sm-3 me-2">
                <img src="../assets/images/profile/user-6.jpg" width="45" class="rounded-circle" alt="">
              </div>
  ...
  <div class="d-flex align-items-center mx-7 py-9 border-bottom">
    <img src="../assets/images/profile/user-6.jpg" alt="user" width="90" class="rounded-circle" />
    <div class="ms-4">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            ...
                            <div class="progress bg-light-subtle w-100" style="height: 4px;">
            ...
            <div class="col-lg-4 d-flex align-items-stretch">
              <div class="card w-100">
                <div class="card-body">
                  ...
                  <div id="usa" style="height: 270px"></div>
                  <div class="mt-4">
                    <div class="hstack gap-4 mb-4">
                      <h6 class="mb-0 flex-shrink-0" style="width: 25px;">LA</h6>
                      <div class="progress bg-light-subtle mt-1 w-100" style="height: 5px;">
                        <div class="progress-bar text-bg-info" role="progressbar" style="width: 28%" aria-valuenow="28"
                          aria-valuemin="0" aria-valuemax="100"></div>
                      </div>
                      <h6 class="mb-0 flex-shrink-0" style="width: 35px;">28%</h6>
                    </div>
                    <div class="hstack gap-4 mb-4">
                      <h6 class="mb-0 flex-shrink-0" style="width: 25px;">NY</h6>
                      <div class="progress bg-light-subtle mt-1 w-100" style="height: 5px;">
                      ...
                      <h6 class="mb-0 flex-shrink-0" style="width: 35px;">21%</h6>
                    </div>
                    <div class="hstack gap-4 mb-4">
                      <h6 class="mb-0 flex-shrink-0" style="width: 25px;">KA</h6>
                      <div class="progress bg-light-subtle mt-1 w-100" style="height: 5px;">
                      ...
                      <h6 class="mb-0 flex-shrink-0" style="width: 35px;">18%</h6>
                    </div>
                    <div class="hstack gap-4">
                      <h6 class="mb-0 flex-shrink-0" style="width: 25px;">AZ</h6>
                      <div class="progress bg-light-subtle mt-1 w-100" style="height: 5px;">
                        <div class="progress-bar text-bg-indigo" role="progressbar" style="width: 12%"
                          aria-valuenow="12" aria-valuemin="0" aria-valuemax="100"></div>
                      </div>
                      <h6 class="mb-0 flex-shrink-0" style="width: 35px;">12%</h6>
                    </div>
                  </div>
                </div>
              </div>
