    ...
    (SweetAlert.prototype.init = function () {
        ...
        $("#sa-image").click(function () {
            Swal.fire({
                ...
                imageUrl: "@@webRoot/assets/images/profile/user-2.jpg",
            });
        });
        ...
        $("#sa-bg").click(function () {
            Swal.fire({
                ...
                width: 600,
                padding: "3em",
                background: "#fff url(@@webRoot/assets/images/backgrounds/active-bg.png)",
                backdrop: `
                          rgba(0,0,123,0.4)
                          url("%40%40webRoot/assets/images/backgrounds/nyan-cat.html")
                          center left
                          no-repeat
                      `,
            });
