  ...
  <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <label for="name">Tution Category Name:</label>
        <input type="text" class="form-control"  v-model="categoryTitle" required placeholder="Add New Tution Category Name">
        <label for="description">Tution Category Description:</label>
        <textarea class="form-control" cols="20" rows="5" v-model="categoryDescription" placeholder="Write Tution Category Description"></textarea>
        </div>
    ...
    <div class="row">
        ...
        <div class="card-body d-flex align-items-center justify-content-between p-4">
          <h4 class="fw-semibold mb-0">Tution Categtories</h4>
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
              <li class="breadcrumb-item">
                <a class="text-muted text-decoration-none" href="index.html">Home</a>
              </li>
              <li class="breadcrumb-item" aria-current="page">Tution Category List</li>
            </ol>
          </nav>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-lg-12">
            ...
            <div class="row  pb-2">
              ...
              <div class="col-lg-2"></div>
                  ...
                  <div class="col-lg-2 mt-3 text-end">
                    ...
                    <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal" style="font-size:16px; font-weight:bold">Add Tution Category</button>
                    </div>  
            </div>
          </div>
        ...
        <thead>
          <tr>
            ...
            <th scope="col" style="font-weight: bold">Tution Category Name</th>
            <th scope="col" style="font-weight: bold">Tution Category Description</th>
      ...
      <tr v-for="(category, index) in categories" :key="category.id">
            ...
            <td data-title="Tution Type Name">{{ category.title }}</td>
            <td data-title="Tution Type Name">{{ category.description }}</td>
            <td data-title="Action" class="action">
  <button type="button" @click="deleteCategory(category.id)" class="btn bg-red"><i class="fa-regular fa-trash-can text-light" style="font-size: 16px;"></i></button>
    
  <router-link :to='{name:"categoryEdit",params:{id:category.id}}' class="btn btn-primary"><i class="fa-regular fa-pen-to-square text-light" style="font-size: 16px;"></i></router-link>
        ...
        <tbody v-else>
          <tr>
              <td colspan="4" align="center">No Tution Categories Found.</td>
          </tr>
        </tbody>
      </table>
          </div>
...
<script>
 import Sidebar from '@/components/admin/Sidebar.vue';
  ...
  this.$axios.post('/api/categories', {
    ...
    .catch(error => {
      console.error('Error adding Tution Categories', error);
    });
},
